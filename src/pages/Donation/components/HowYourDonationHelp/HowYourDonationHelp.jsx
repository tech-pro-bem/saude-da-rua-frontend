...
const HowYourDonationHelp = () => {
  return (
    <Container>
      ...
      <AccountabilityContainer>
        <AccountabilityItem>
          <img src={supportIcon} alt="ícone de pessoa ao lado de um coração" />
        ...
        <AccountabilityItem>
          ...
          <p>
            Medicamentos, testes rápidos (glicemia, Hepatite B, C, HIV, Sífilis
            e Covid-19) e aferição da pressão arterial.
          </p>
        </AccountabilityItem>
      </AccountabilityContainer>
    </Container>
